    ...
    int retorno=0;
       ...
       if(arrayEmpleado !=NULL && tamArray>=0)
       {
    	   	   ...
    	   	   for(i=0; i<tamArray-1; i++)
    		   {
    			   ...
    			   {
    				   if(strcmp(arrayEmpleado[i].apellido, arrayEmpleado[j].apellido) > 0 || (strcmp(arrayEmpleado[i].apellido, arrayEmpleado[j].apellido) == 0 && arrayEmpleado[i].sector > arrayEmpleado[j].sector))
    				   {
...
void promedioTotal(eEmpleado arrayEmpleado[], int tamArray)
{
    ...
    salarioPromedio = salario / contador;
      ...
      for (int i=0;i<tamArray;i++)
        {
            if (arrayEmpleado[i].isEmpty==0 && arrayEmpleado[i].salario >= salarioPromedio)
            {
                contadorPromedio++;
            }
